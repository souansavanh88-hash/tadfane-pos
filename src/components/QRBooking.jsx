...
export default function QRBooking({ currentUser, preloadedBookingId, clearPreloadedBooking }) {
  ...
  const canDelete = (currentUser?.role === "owner" || currentUser?.role === "admin" || currentUser?.permissions?.["checkin-tickets"]?.delete === true) && currentUser?.role !== "cashier" && currentUser?.role !== "sales";
